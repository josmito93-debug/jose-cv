...
export const ShoppingIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const fieldIcons: Record<string, React.FC<IconProps>> = {
  businessName: BuildingIcon,
  city: LocationIcon,
  email: EmailIcon,
  phone: PhoneIcon,
  socialMedia: SocialIcon,
  services: ShoppingIcon,
  brandColors: PaletteIcon,
  logo: ImageIcon,
  schedule: ClockIcon,
  exactLocation: MapIcon,
  companyHistory: BookIcon,
  team: UsersIcon,
};

export const getFieldIcon = (field: string): React.FC<IconProps> => {
  return fieldIcons[field] || DocumentIcon;
};

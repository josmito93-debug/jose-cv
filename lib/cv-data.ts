export const siteData = {
  en: {
    ...
    projects: [
      {
        title: "ATTOMCollector",
        link: "/collector",
        subtitle: "Recopilación inteligente de información empresarial.",
        desc: "Sistema de recopilación inteligente diseñado para Universa Agency. ATTOMCollector utiliza flujos conversacionales de IA para capturar y estructurar información crítica de clientes, optimizando la calificación de leads y la prospección de forma autónoma."
      },
      {
      ...
      },
      {
        ...
        desc: "Led the full digital brand creation for a music industry platform. Desarrollé la identidad visual, construí un sitio web interactivo y estructuré campañas de Google Ads para captación de audiencia y crecimiento en streaming."
      },
      {
      ...
      },
      {
        ...
        desc: "Designed a digital platform for travel services con un enfoque en user journey and engagement. Applied conversion-focused design principles to increase inquiries and lead generation."
      }
    ],
    lists: {
      stack: [
